...
class Category extends Node {
	...
	/**
	 * Below come the default values for Baum's own Nested Set implementation column names.
	...
	public static function getCategories()
	{
		...
		{	
			...
			else
			{
				...
				$categories_ids = Acl::getAdminEntitiesIDs('Category');
				
				if( ! empty($categories_ids))
				{
					$categories = $categories->orWhereIn('id', Acl::getAdminEntitiesIDs('Category'));
				}	
